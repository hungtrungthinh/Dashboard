...
public function getRestaurantLists($status,$key,$num,$offset){
		...
		$sql = "SELECT fk_member_admins.admin_id, fk_member_admins.full_name, 
					...
					fk_restaurant_master.name,fk_restaurant_master.phone,fk_restaurant_master.status,fk_restaurant_master.forkourse_stripe_status,
					fk_restaurant_master.forkourse_stripe_percentage
