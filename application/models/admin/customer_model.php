...
class Customer_model extends MY_Model { 	
	...
	public function getCustomerDetails($restaurant_id,$key,$num,$offset){
			$sql     = "SELECT fk_member_master.*, fk_restaurant_master.name
						...
						ON (fk_restaurant_master.restaurant_id = $restaurant_id)
						LEFT JOIN fk_restaurant_members 
						ON (fk_restaurant_members.membar_id = fk_member_master.member_id)
						WHERE fk_restaurant_members.restaurant_id = $restaurant_id";
			if($key != ''){
