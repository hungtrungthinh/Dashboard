...
//AND T2.location_id='".$location_id."'	
	...
	public function getAllCustomerReport($restaurant_id,$location_id,$offset,$limit,$startDate,$endDate){
		...
		(SELECT SUM(total_amount) as pickup FROM fk_order_master WHERE order_type='pickup' AND member_id=T2.member_id) as pickup,
		(SELECT COUNT(*) as pickup_count FROM fk_order_master WHERE order_type='pickup' AND member_id=T2.member_id) as pickup_count,
		(SELECT SUM(total_amount) as delivery FROM fk_order_master  WHERE order_type='Delivery' AND member_id=T3.member_id) as delivery ,
		(SELECT COUNT(*) as  delivery_count FROM fk_order_master  WHERE order_type='Delivery' AND member_id=T3.member_id) as delivery_count ,
		(SELECT SUM(total_amount) as app FROM fk_order_master  WHERE source_type='app' AND member_id=T3.member_id) as app ,
		(SELECT COUNT(*) as  app_count FROM fk_order_master  WHERE source_type='app' AND member_id=T3.member_id) as app_count ,
		(SELECT SUM(total_amount) as website FROM fk_order_master  WHERE source_type='website' AND member_id=T3.member_id) as website ,
		(SELECT COUNT(*) as  website_count FROM fk_order_master  WHERE source_type='website' AND member_id=T3.member_id) as website_count ,
		(SELECT SUM(total_amount) as facebook FROM fk_order_master  WHERE source_type='facebook' AND member_id=T3.member_id) as facebook ,
		(SELECT COUNT(*) as  facebook_count FROM fk_order_master  WHERE source_type='facebook' AND member_id=T3.member_id) as facebook_count , " ;
