...
class Configuration extends MY_Controller {
	...
	public function settings(){
		...
		$data['configlist']=$this->config_model->get_many_by(array('editable'=>'Y','admin_can_edit'=>'Y'));
