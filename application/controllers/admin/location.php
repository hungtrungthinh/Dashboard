...
public function lists(){
			...
			$data['resdetails']		= $row = $this->location_model->get_where('fk_restaurant_master',array('restaurant_id'=>$restaurant_id),'row');
			
			//echo "<pre>";  print_r($data['resdetails']	); echo "</pre>"; exit;
			...
			$data['totalnum']=count($data['locationlist']);
			//echo "<pre>";  print_r($data['locationlist']	); echo "</pre>"; exit;
		//----------------------------------------------------------
	   //echo "here";exit;
