         ...
         <?php if($result['type']==''){?>
                 ...
                 <div class="form-group">
                        ...
                        <select name="type" id="type" class="form-control" >
                            <option value="both" selected="selected">Select</option>
		 ...
		 ?> 
               <!-- Text input-->  
                <div class="form-group">
                    <label class="col-sm-2 control-label" for="textinput">Type</label>
                    <div class="col-sm-10">
                      <input type="text" name="type"  id="type" value="<?=(isset($result['type']))?$result['type']:''?>" placeholder="Type" class="form-control fileldtheme js-placeholder"  >
