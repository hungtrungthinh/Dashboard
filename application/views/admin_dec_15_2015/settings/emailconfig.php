  ...
  <table class="table table-bordered table-hover"> 
	...
	<tbody>
     ...
     <?php foreach($templatelist as $val) : ?>
		...
		<tr href="<?php echo base_url()?>index.php/admin/configuration/addemail/<?php echo $val['email_id'];?>" style="cursor:pointer">
		
			
	        <td>
			<a href="<?php echo base_url()?>index.php/admin/configuration/addemail/<?php echo $val['email_id'];?>"" class="link1">
