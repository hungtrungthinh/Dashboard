...
<div class="container"> 
	<div class="row">
    <form id="nudgeForm" class="form-horizontal" role="form" action="" method="post">
							...
							<fieldset>
							  <div class="form-group">
								...
								<div class="col-sm-10">
									  ...
									  <span class="alert-danger"><?php echo form_error('email_title');?></span>
								</div>
							  </div>
					         ...
					         <div class="form-group">
								...
								<div class="col-sm-10">
									  ...
									  <span class="alert-danger"><?php echo form_error('email_subject');?></span>
								</div>
