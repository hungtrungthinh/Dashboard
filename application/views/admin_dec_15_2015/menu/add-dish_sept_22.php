 ...
 <div class=""> 
    ...
    <div class="col-md-12">
        ...
        <div class="col-md-4">
            ...
            <label for="control-label" class=" control-label">This Products does not have different size</label>
            </div>
            </div>
            <div class="col-md-7">
            <div class="form-group">
        ...
        <div class="col-md-4">
         ...
         <div class="col-md-3">
          ...
          <div class="col-md-3">            
                    ...
                    <span>   <input type="checkbox" checked="true" name="multiple_1" id="multiple_1" 
                    class="multiple_1" style="height:15px !important"/>
                    ...
                    <table class="table table-striped">
                      ...
                      <tbody class="table_body addmoresize_1">
                           <tr id="sidesdiv_1_1" class="sidesdiv_1">
                                 <td><input type="text" class="errorsize_1 optionsides_1" placeholder="Sides" id="sides_1_1" style="" name="sides_1[]" ></td>  
                                  <td><input type="text" onkeypress="return isNumber(event)" class="errorsize_1 optionprice_1" placeholder="Price" id="price_1_1" style="" name="price_1[]"></td>  
              ...
              <li id="optionlist_<?php echo $val['option_id']; ?>" data-attr="" >
  				<div class="sides_wp">
                    <h5 class="item_lid">
                      ...
                      <input type="checkbox" <?php if($val['mandatory']=='true'){?>checked="true"<?php }?> name="mandatory_<?php echo $val['option_id'] ; ?>" id="mandatory_<?php echo $val['option_id'] ; ?>" class="mandatory_<?php echo $val['option_id'] ; ?>">
                      <span>*</span> This is Mandatory</span>
                    ...
                    <span>   <input type="checkbox" <?php if($val['multiple']=='Y'){?>checked="true"<?php }?> name="multiple_<?php echo $val['option_id'] ; ?>" id="multiple_<?php echo $val['option_id'] ; ?>" class="multiple_<?php echo $val['option_id'] ; ?>">
                      <span>*</span>Allow multiple options </span>
                          ...
                          <a href="javascript:void(0)"  class="pull-right glyphicon glyphicon-trash"  onclick="deleteall('<?php echo $val['option_id'];?>')"></a>
                      <div class="pull-right"> 
                      <?php if($itemdetails['item_id']!=''){;?>
                      <a href="javascript:void(0)"  class="pull-right" ><span class="all_options_edit span_<?php echo $val['option_id'];?>  glyphicon glyphicon-edit " id="span_<?php echo $val['option_id'];?>" title="Double click to edit" data-attr="<?php echo $val['option_id'] ; ?>"></span></a>
                      <?php }?>
                ...
                <?php 
					...
					<span class="save_options edit_<?php echo $val['option_id'] ; ?>"  id="edit_<?php echo $val['option_id'] ; ?>"  data-attr="<?php echo $val['option_id'] ; ?>"  style="display:none;">
					 <input type="text"  id="saveopt_<?php echo $val['option_id'] ; ?>" name="opt_name_<?php echo $val['option_id'];?>[]" class="opt_name_<?php echo $val['option_id'] ; ?>" value="<?php echo $valu['side_item']; ?>">
                    </span>  
					...
					<span class="save_options edit_<?php echo $val['option_id'] ; ?>"  id="edit_<?php echo $val['option_id'] ; ?>"  data-attr="<?php echo $val['option_id'] ; ?>"  style="display:none;">
					 <input type="text"  id="saveopt_<?php echo $val['option_id'] ; ?>" name="opt_price_<?php echo $val['option_id'];?>[]" class="opt_price_<?php echo $val['option_id'] ; ?>" value="<?php echo $valu['price']; ?>">
                    </span>
...
$(function() {
	...
	$('body').on('click', '.addmoresides', function () {
		...
		if(flag!=0){
			$('.addmoresides').hide();
			$('.newli_'+opt_id).append('<li id="newside_<?php //echo $valu['side_id']; ?>" class="newside_<?php //echo $val['option_id'];?>" data-attr="" ><span class="save_options edit_<?php //echo $val['option_id'] ; ?>"  id="edit_<?php //echo $val['option_id'] ; ?>"  data-attr="<?php //echo $val['option_id'] ; ?>"><input type="text"  id="saveopt_<?php //echo $val['option_id'] ; ?>" name="opt_name_<?php //echo $val['option_id'];?>[]" class="opt_name_'+opt_id+'" value=""></span><div class="pull-right"><label class="action pull-right"></label><label class="action pull-right"><a href="javascript:void(0);" class="pull-right addmoresides" data-attr="<?php //echo count($sidesdetails[$val['option_id']]); ?>" data-rel="'+opt_id+'"><img src="<?php echo base_url()?>assets/admin_lte/img/plus_icon.png"></a></label><label class="rate">+$<input type="text"  id="saveopt_<?php //echo $val['option_id'] ; ?>" name="opt_price_<?php //echo $val['option_id'];?>[]" class="opt_price_<?php //echo $val['option_id'] ; ?>" value=""></label></div></li>');
