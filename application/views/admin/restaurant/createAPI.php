	...
	<div class="col-md-12" style="padding-bottom:15px;">
		...
		<form class="form-horizontal" role="form" action="<?php echo base_url()?>index.php/admin/restaurant/apiGenarete" method="post" name="formlist" onsubmit="" id="formlist">
            ...
            <div class="form-group">
            	...
            	<div class="col-sm-6">
             	<input type="text" name="site_url" id="site_url" value="https://dashboard.forkourse.com/weborder/" placeholder="Site Url " class="form-control fileldtheme js-placeholder" readonly="readonly" ><small><i>Site Url</i></small>
          ...
          <div class="form-group">
            	...
            	<div class="col-sm-6">
             	<input type="text" name="page_tab_url" id="page_tab_url" value="https://dashboard.forkourse.com/weborder/home/<?php echo $restaurant_id;?>" placeholder="Secure Page Tab URL" class="form-control fileldtheme js-placeholder" readonly="readonly" ><small><i>Secure Page Tab URL</i></small>
