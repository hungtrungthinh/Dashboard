        ...
        <table class="table table-striped tbl_category">
          ...
          <tbody class="table_body">
            ...
            <tr id="row_<?php echo $order['order_id'];?>">
               ...
               <td href="<?php echo base_url().$this->user->root;?>/orders/details/<?php echo $order['order_id'];?>" style="cursor:pointer;" class="tdlink"><?php 
echo date(" g:i a m/j / y",strtotime($order['created_time']));?></td>
               <td href="<?php echo base_url().$this->user->root;?>/orders/details/<?php echo $order['order_id'];?>" style="cursor:pointer;" class="tdlink"><?php echo date(" g:i a m/j / y",strtotime($order['delivery_time'])) ;?></td>
               ...
               <?php } ?>
                  <td href="<?php echo base_url().$this->user->root;?>/orders/details/<?php echo $order['order_id'];?>" style="cursor:pointer;" class="tdlink"><?php echo $order['auth_type'];?></td>
               <!--<td>
...
//Change Limit of pagination
	$(document).on('change', '#limit', function() {
			$("#userMasterForm").attr("action", "<?php echo base_url().$this->user->root;?>/orders/all");
