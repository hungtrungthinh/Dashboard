  ...
  <!-- ===== Start Section Main ===== -->
        ...
        <div class="alert alert-success hide" role="alert"></div>
            ...
            <div class="container-fluid">
				...
				<form name="form-order" id="form-order" action="<?php echo base_url().$this->user->root?>/orders/cancelled" method="post" >  
                    <!-- Nav tabs -->
                    <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li role="presentation"  class="active"><a href="<?php echo base_url().$this->user->root;?>/orders/cancelled" aria-controls="declined" >
                        Declined </a></li>
           	...
           	foreach($orderdetails as $items){ ?>
									...
									case 'app': ?>
                                                    ...
                                                    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                                         width="52px" height="52px" viewBox="0 0 52 52" enable-background="new 0 0 52 52" xml:space="preserve">
                                                    <circle fill="#1C3749" cx="26" cy="26" r="25.364"/>
                                                    <text transform="matrix(1 0 0 1 21.2852 34.2441)" fill="#FFFFFF" font-family="'FontAwesome'" font-size="25">&#xf10b; </text>
                                                    </svg>
                                              <?php break; 
									default : ?>
                                                <!-- Generator: Adobe Illustrator 16.0.0, SVG Export Plug-In . SVG Version: 6.00 Build 0)  -->
                                                ...
                                                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                                     width="52px" height="52px" viewBox="0 0 52 52" enable-background="new 0 0 52 52" xml:space="preserve">
                                                <circle fill="#1C3749" cx="26" cy="26" r="25.364"/>
                                                <text transform="matrix(1 0 0 1 21.2852 34.2441)" fill="#FFFFFF" font-family="'FontAwesome'" font-size="23">&#xf109; </text>
                                                </svg>
                                              <?php break; 
									}?>
...
<script>
	...
	$(document).on('change', '#limit', function() {
			$("#form-order").attr("action", "<?php echo base_url().$this->user->root;?>/orders/cancelled");
