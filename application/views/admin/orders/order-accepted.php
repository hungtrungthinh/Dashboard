            ...
            <div class="container-fluid">
				...
				<form name="form-order" id="form-order" action="<?php echo base_url().$this->user->root?>/orders/accepted" method="post" >   
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li role="presentation"  class="active"><a href="<?php echo base_url().$this->user->root;?>/orders/accepted" aria-controls="accepted">
           	...
           	foreach($orderdetails as $items){ ?>
									...
									case 'app': ?>
                                                    ...
                                                    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                                         width="52px" height="52px" viewBox="0 0 52 52" enable-background="new 0 0 52 52" xml:space="preserve">
                                                    <circle fill="#1C3749" cx="26" cy="26" r="25.364"/>
                                                    <text transform="matrix(1 0 0 1 20.2852 35.2441)" fill="#FFFFFF" font-family="'FontAwesome'" font-size="23">&#xf10b; </text>
                                                    </svg>
                                              <?php break; 
									default : ?>
                                                <!-- Generator: Adobe Illustrator 16.0.0, SVG Export Plug-In . SVG Version: 6.00 Build 0)  -->
                                                ...
                                                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                                     width="52px" height="52px" viewBox="0 0 52 52" enable-background="new 0 0 52 52" xml:space="preserve">
                                                <circle fill="#1C3749" cx="26" cy="26" r="25.364"/>
                                                <text transform="matrix(1 0 0 1 20.2852 35.2441)" fill="#FFFFFF" font-family="'FontAwesome'" font-size="26">&#xf109; </text>
                                                </svg>
                                              <?php break; 
									}?>
