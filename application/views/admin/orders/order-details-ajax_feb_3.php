                                              ...
                                              <?php if($usertype=="manager") { ?>
                                                ...
                                                <dl>          
                                                    ...
                                                    <dd>
                                                        ...
                                                        <?php echo $order['city'];?>, <?php echo $order['zipcode'];?><br>
                                                        ...
                                                        <td colspan="5" style="padding:0; border:none;">
                                                            <div class="table_sides">
                                                                <table class="table">
                                                                    <tbody>
                                                                        <tr>
                                                                            <td class="sub-category" style="padding:0 0 0 10px; border:none;"><?php echo $valu ['options']; ?>:</td>
                                                                          ...
                                                                          <?php $sidesdata=unserialize($valu['sides']);
                                                                           ...
                                                                           for($i=0;$i<count($sides);$i++){ ?>
                                                                          <tr>
                                                                            <td class="sub-category" style="padding:0 0 0 4%; border:none;">
                                                                                <i class="fa fa-angle-double-right"></i> <?php echo $sides[$i]; ?>
                                                                            </td>
                                                                            <td class="sub-category-price" style="padding:0; border:none;">
																			<?php echo '+ $'.number_format($price[$i],2); ?></td>
                                                                        </tr>
                                                                         <?php 
																			 }
																			 ?>
                                                       ...
                                                       <?php }else if($order['order_status']=="Completed" && $usertype!="manager" && $orderdetails[0]['refund_amount']==""){?>
                                                        ...
                                                        <div class="accept-links accept-links-new acbtncls" >
                                                         ...
                                                         <div class="accept-links accept-links-new cmpbtncls" style="display:none;">
                                                            ...
                                                            <div class="col-md-6 col-sm-6 col-xs-6">
                                                                <a href="javascript:void(0)" class="continue accept-btn">CONTINUE</a>
                                                            </div>
