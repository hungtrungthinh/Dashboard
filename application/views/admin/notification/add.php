<section class="profile">
        	<div class="container">
                ...
                <div class="profile-container custome-message">
                                ...
                                <div class="row" style="margin-top:40px;">
                                    <div class="col-lg-6 col-md-6 col-sm-4">
                                    	<div class="toggle-switch">
                                        	<p>Show / Hide</p>
                                            <label class="switch">
                                                <input type="checkbox"  <?php if($details['status']!='N'){ ?> checked="true" <?php } ?> name="status" id="msgstatus" >
                	...
                	<!-- Custome Message Form -->
					<form class="cm2" role="form"  method="post" name="formlist" action="<?php echo base_url()?>index.php/admin/notification/sendPush/<?php echo $this->session->userdata('user')->restaurant_id ?>">
                        <div class="basic-details">
                            <div class="user-credential">
