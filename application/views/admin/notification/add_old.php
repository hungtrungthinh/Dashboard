...
<div class="container" style="padding-bottom:10px;"> 
	 <div class="clearfix" style="padding-top:15px;"></div>
        ...
        <div class="col-lg-12">
	      <legend>Instant Notification</legend>
		</div> 
	 
    <div class="col-md-12" style="padding-bottom:10px;">
    
		<form class="form-horizontal" role="form"  method="post" name="formlist" action="<?php echo base_url()?>index.php/admin/notification/sendPush">
        	<fieldset>
      ...
      <div class="col-sm-10">  
         <button type="submit" class="btn btn-info pull-right" name="send" id="send" style="margin-right:10px;" >Send</button>
       </div>  
