	...
	$("#deleteSel").click(function(){
		...
		if(chkCnt==0){
			...
			if(confirm('Are you sure to delete the selected user(s)?')){
				$("#userMasterForm").attr("action", "<?php echo base_url().$this->user->root;?>location/index");
...
$("#bulkaction").change(function(){
		...
		if(chkCnt==0){
			...
			if(confirm('Are you sure to delete the selected location(s)?')){
				$("#userMasterForm").attr("action", "<?php echo base_url().$this->user->root;?>/location/bulkAction");
				$("#userMasterForm").submit();return true;
			}
			else{
				return false;
    ...
    <ul role="tablist" class="nav nav-tabs tab_links" id="myTabs">
      ...
      <li style="width:90%;">
            ...
            <div class="col-lg-5">
     		...
     		<div class="col-lg-1"><a href="<?php echo base_url().$this->user->root;?>/location/add" class=" orange-link">Add New</a></div>
      </li>
                ...
                <table class="table table-striped tbl_category">
                  <thead class="head_table">
                    <tr>
                      ...
                      <th class="col-md-1 col-sm-1" ><span class="link_blak" >Actions</span></th>
                      ...
                      <th class="col-md-1 col-sm-1">Open</th>
                  ...
                  <tbody class="table_body">
                    ...
                    <tr id="row_<?php echo $items['order_id'];?>">
                      <td>
                            <center>
                             <input  type="checkbox" name="sel[]" value="<?php echo $items['location_id']?>"  rel="" class="chk"  />
                            </center>
                        </td>
                        <td>
                            <center>
                       ...
                       <td href="<?php echo base_url().$this->user->root;?>/location/add/<?php echo $items['location_id'];?>" style="cursor:pointer;" class="full_link"><?php echo $items['type'];?></td>
