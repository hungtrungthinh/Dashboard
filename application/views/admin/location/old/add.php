...
.brudcum_head{
 ...
 <div class="container" style="padding-bottom:10px;"> 
    ...
    <div class="col-md-12" style="padding-bottom:10px;">
		...
		<form class="form-horizontal" role="form" action="" method="post" name="formlist" onsubmit="<?php echo base_url().$this->user->root;?>/location/add" id="formlist">
        	<fieldset>
       		<!-- Text input-->
		   ...
		   <!-- Text input-->
          	<div class="form-group">
				 ...
				 <div class="col-sm-2">
                 <input type="text" name="zipcode" value="<?=(isset($result['zip_code']))?$result['zip_code']:''?>"  placeholder="Zipcode" class="form-control fileldtheme js-placeholder zipcode " data-bvalidator="required" data-bvalidator-msg="Please enter Zipcode"  >
		         </div>
                 <div class="col-sm-2">
                 <input type="text" name="city" value="<?=(isset($result['city']))?$result['city']:''?>"  placeholder="City"  class="form-control fileldtheme js-placeholder city"  readonly="readonly">
		         </div>
                 <div class="col-sm-2">
                 <input type="text" name="state" value="<?=(isset($result['state']))?$result['state']:''?>"  placeholder="State" class="form-control fileldtheme js-placeholder state"  readonly="readonly">
		         </div>
           </div>
            <!-- Text input-->
          <div class="form-group">
         ...
         <!-- Text input-->
 		 <div class="form-group">
            	...
            	<div class="col-sm-6">
             	<input type="text" name="phone" value="<?=(isset($result['phone']))?$result['phone']:''?>" placeholder="Phone Number" class="form-control fileldtheme js-placeholder" >
        ...
        <div class="form-group">
                ...
                <textarea class="form-control additem" name="description" id="description" role="4"><?=(isset($result['description']))?$result['description']:''?></textarea>
                </div>
         </div>	
    ...
    <div class="col-lg-12">
      ...
      <?php if($result['username']!=''){?>
       <!-- Text input-->  
        <div class="form-group">
            ...
            <div class="col-sm-6">
              <input type="text" name="username" readonly id="username" value="<?=(isset($result['username']))?$result['username']:''?>" placeholder="User Name" class="form-control fileldtheme js-placeholder" data-bvalidator="required" data-bvalidator-msg="Please enter User Name" >
	       </div> 
       ...
       <!-- Text input-->  
        <div class="form-group">
            <label class="col-sm-4 " for="textinput">User Name</label>
            <div class="col-sm-6">
              <input type="text" name="username" value="<?=(isset($result['username']))?$result['username']:''?>" id="username" placeholder="User Name" class="form-control fileldtheme js-placeholder"  >
      ...
      <div class="col-sm-10">  
          <input type="hidden" value="<?=(isset($result['restaurant_id']))?$result['restaurant_id']:''?>"  id="restaurant_id"/>
          <input type="hidden" value="<?=(isset($result['admin_id']))?$result['admin_id']:''?>" id="admin_id" />
