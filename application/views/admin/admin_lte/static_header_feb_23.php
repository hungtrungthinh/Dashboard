...
<head>
        ...
        <link rel="apple-touch-icon" href="<?php echo base_url(); ?>apple-touch-310x310.png"/>
...
<body class="skin-black">
		<header class="sign-in">
        	<div class="container">
            	<div class="row">
                	<div class="col-lg-5 col-md-5 col-sm-5 col-xs-5 display-ful col-center">
                    	<div class="page-title">
                        	<h1 id="header-title"><?php  echo $title?$title:'Sign In'; ?></h1>
                        </div>
                    </div>
                </div>
            </div>
...
<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 width="68px" height="33px" viewBox="0 0 68 33" enable-background="new 0 0 68 33" xml:space="preserve">
<polygon fill="#FFFFFF" points="33.1,32 1.752,32.347 34.087,0 66.436,32.336 "/>
</svg>'; ?>
