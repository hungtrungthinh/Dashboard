		...
		c0,1.711-1.387,3.099-3.1,3.099s-3.1-1.388-3.1-3.099C20.568,41.343,21.956,39.955,23.668,39.955L23.668,39.955z"/>
                            ...
                            <?php } ?>
                            	...
                            	<form id="myform1" action="<?php echo site_url('admin/login/authenticate_admin');?>" method="post">
                                	<label>
                                		<input type="text" name="userid" id="username"  placeholder="User name" required />
                                    </label>
                                    <label>
                                		<input type="password" name="password" id="password"  placeholder="Password" required />
                                    </label>
                                    <input type="button" id="submitbut" class="loginBtn" value="Sign me in" />
                                </form>
...
<style>
.loginBtn{
background: none repeat scroll 0 0 rgb(20, 57, 75);
    border: medium none;
  ...
  if(event.keyCode == 13){
	...
	var password=$("#password").val();
			...
			$.ajax({	
						...
						url:"<?php echo base_url()?>admin/login/check_login1",
						type:"POST",
