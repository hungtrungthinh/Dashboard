                      ...
                      <input type="hidden" name="item_id" id="item_id" value="<?php echo $itemdetails['item_id'];?>" >      
                            	...
                            	<div class="col-lg-6 col-md-6 col-sm-3 col-xs-3 display-ful">
                                	<div class="breadcrumb-box">
                                        <ul>
											...
											<span id="brud_cat" style="cursor:pointer;">
                                            ...
                                            <li class="active">
											<span id="brud_item"><?php echo stripslashes($itemdetails['item_name']);?></span>
                                            </li><?php } ?>
                        ...
                        <div class="form-box add-dish-box">
                        	<div class="row">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 display-ful">
                                    <div class="add-dish-field">
                                        <input type="text" name="menu_chinese_name" class="menuclass menudishtop" value="<?php echo stripslashes($itemdetails['item_chinese_name']);?>" id="menu_chinese_item"  placeholder="Alternative Name"  data-val="Dish Item">
                                    </div>
                                </div>
                                <!-- End Form Field -->
                            </div>
                                ...
                                <div class="form-box option-table-container tile opt_<?php echo $itemdetails['item_id'];?>" id="optionlist_<?php echo $val['option_id']; ?>" data-attr="<?php echo $itemdetails['item_id'];?>" data-val="<?php echo $val['option_id']; ?>">
                                    ...
                                    <table class="table option-table edit-option-table">
                                        <tbody class="after-768-none">
                                            <tr>
                                                <td>
                                                    <input type="text"  placeholder="Enter your option name" id="opt_title_<?php echo $val['option_id'] ; ?>" name="opt_title_<?php echo $val['option_id'];?>" class="save_optionssss" value="<?php echo $val['option_name'] ; ?>" data-attr="<?php echo $val['option_id'] ; ?>">
                                                    <input type="hidden" name="opid[]" value="<?php echo $val['option_id'] ; ?>" />
                                                </td>
                                                <td>
                                                    <div class="label-check-box">
                                                        <label>
                                        ...
                                        <tbody class="after-768-show">
                                            <tr>
                                                <td>
                                                    <input type="text"  placeholder="Enter your option name" id="opt_title_<?php echo $val['option_id'] ; ?>" name="opt_title_mob_<?php echo $val['option_id'];?>" class="" value="<?php echo $val['option_name'] ; ?>">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                    ...
                                    <table class="table table-hover sizes-table tble-drag newli_<?php echo $val['option_id']; ?>"  data-attr="<?php echo $val['option_id']; ?>">
                                        ...
                                        <?php 
											...
											<tr data-attr="<?php echo $valu['option_id'] ; ?>" data-val="<?php echo $valu['side_id'] ; ?>" id="sideslist_<?php echo $valu['side_id'];?>" class="tr_opt_<?php echo $val['option_id'] ; ?>">
                                                ...
                                                <input type="text"  id="saveopt_<?php echo $valu['side_id'] ; ?>" name="opt_name_<?php echo $valu['side_id'];?>[]" class="addInput opt_name_<?php echo $val['option_id'] ; ?> inputside inputnew" value="<?php echo $valu['side_item']; ?>" data-rel="<?php echo $valu['side_id'] ; ?>" >
                                                </span>
                                                </td>
                                                <td>
                                                ...
                                                <input type="text"  id="saveoptprice_<?php echo $valu['side_id'] ; ?>" name="opt_price_<?php echo $valu['side_id'];?>[]" class="inputprice opt_price_<?php echo $val['option_id'] ; ?> inputnew" value="<?php echo $valu['price']; ?>" onkeypress="return isNumber(event)" data-attr="<?php echo count($sidesdetails[$val['option_id']]); ?>" data-rel="<?php echo $val['option_id'] ; ?>">
                                                </span>
...
<script>
	...
	$('body').on('click', '.remove_option', function () {
	 ...
	 $('body').on('click', '.submit_btn', function () {
            ...
            var chinese_name = $('#menu_chinese_item').val();
			var description = $.trim($('#description').val());
			var item_id=$('#item_id').val();
			...
			if(category == '' ){
			  ...
			  //for sizes and Prices
				...
				//alert(arrLimit);
				//alert(arrOptid);
				var OptArrayID=Array();
				var OptNameArray=Array();
				var OptSideArray=Array();
				var OptPriceArray=Array();
				var newsoptionArray=Array();
				
				
				
				var newsideArrayID=Array();
				var newsideArray=Array();
				var newsideoptArray=Array();
				...
				$( ".save_optionssss" ).each(function() {
						...
						//if($("#saveopt_"+opid).val()!=''){
							...
							newsoptionArray.push($("#opt_title_"+opid).val());
							newsoptionArray.push($("#opt_title_"+opid).val());
							//newsideArray.push($("#saveopt_"+opid).val());
						//}
				});
				
				$( ".save_optionsides" ).each(function() {
						var opid=$(this).attr('data-attr');
						//alert(opid);
						newsideoptArray.push(opid);
						//newsideArray[opid]=$("#saveopt_new").val();
						newsideArray.push($("#saveopt_new_"+opid).val());
				});
							...
							success: function(response){
								if(response==0){
									...
									$.ajax({
										...
										data : {'category':category,'menu_item':menu_item,'item_id':item_id, 'item_chinese_name' : chinese_name, 'description':description,'price_array':price_array,'size_array':size_array,'map_id':map_id,'nosize':nosize,'optionsides':optionsides,'optionprice':optionprice,'option_item':option_item,'mandatory':mandatory,'multiple':multiple,'mul_lim':mul_lim,'arrOptid':arrOptid,'arrMan':arrMan,'arrMul':arrMul,'newsideArrayID':newsideArrayID,'newsideArray':newsideArray,'newPriceArray':newPriceArray,'newsoptionArray':newsoptionArray,'newsideoptArray':newsideoptArray,'arrLimit':arrLimit},
										success: function(response){
											...
											//alert("here");
											window.location.href="<?php echo base_url().$this->user->root;?>"+"/menu/add_dish/"+category+"/"+item_id;
