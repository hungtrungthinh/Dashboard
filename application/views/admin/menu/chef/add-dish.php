       	...
       	<section class="main-sec">
            <div class="container-fluid">
            	...
            	<div class="add-dish-form">
                	<!-- Start Form -->
    				<form role="form" action="<?php echo base_url().$this->user->root;?>/menu/add_dish" method="post" name="formlist"  id="formlist">	
                        	...
                        	<div class="row">
                            	...
                            	<div class="col-lg-6 col-md-6 col-sm-3 col-xs-3 display-ful">
                                	<div class="breadcrumb-box">
                                        <ul>
                                        	<li><a href="<?php echo base_url().$this->user->root;?>/menu/category">Menu</a></li>
                                        	<?php if($categoryDetails['category_name']!='') {?>
      										<li class="CatAjax" data-attr="<?php echo $categoryDetails['category_id'];?>">
											<a href="<?php echo base_url().$this->user->root;?>/menu/dish/<?php echo $categoryDetails['category_id'];?>">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                <button type="button" aria-label="Close" data-dismiss="modal">Cancel</button>
                            </div>
                        </div>
                    </div>
                    <!-- End Modal Footer -->
