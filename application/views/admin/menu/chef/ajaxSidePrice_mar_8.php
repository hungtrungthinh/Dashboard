...
if(count($sidesdetails)!=0){ 
	...
	foreach($sidesdetails as $valu){  ?>
    										...
    										<tr data-attr="<?php echo $valu['side_id'] ; ?>" id="sideslist_<?php echo $valu['side_id'];?>" class="tr_opt_<?php echo $option_id; ?> sideslist_<?php echo $option_id;?>">
                                                ...
                                                <input type="text"  id="saveopt_<?php echo $valu['side_id'] ; ?>" name="opt_name_<?php echo $option_id;?>[]" class="addInput opt_name_<?php echo $option_id; ?> inputside inputnew" value="<?php echo $valu['side_item']; ?>" data-rel="<?php echo $valu['side_id'] ; ?>" >
                                                </span>
                                                </td>
                                                <td>
