                ...
                <div class="menu-tabs">
                    ...
                    <div class="tab-content">
						...
						//	print_r($newar);
							...
							?>
                        	<table class="table table-hover for-view-higher-481">
                                <thead>
                                    <tr>
								...
								for($i=0;$i<count($categorylist);$i++){//echo $i; 
									//foreach($categorylist as $items){ ?>
                                
									<tr id="row_<?php echo $categorylist[$i]['category_id'];?>" data-attr="<?php echo $categorylist[$i]['category_id'];?>" class="cat_tr">
                                    
                                        
                                    
                                    	<td class="tdlink" href="<?php echo base_url().$this->user->root;?>/menu/dish/<?php echo $categorylist[$i]['category_id'];?>" ><?php echo $categorylist[$i]['category_name'];?></td>
                                        <td class="tdlink" href="<?php echo base_url().$this->user->root;?>/menu/dish/<?php echo $categorylist[$i]['category_id'];?>" ><?php echo $categorylist[$i]['subtitle'];?></td>
                                        <td>
                                        	<label class="switch">
                                                <input type="checkbox" <?php if($categorylist[$i]['status']=='Y'){ ?> checked=""  <?php } ?> onClick="cat_status(<?php echo $categorylist[$i]['category_id'];?>,'<?php echo $categorylist[$i]['status'];?>')" class="cat_status_<?php echo $categorylist[$i]['category_id'];?>" data-val="<?php echo $categorylist[$i]['status'];?>" >
                                                <span class="switch-label" data-on="Yes" data-off="No"></span> <span class="switch-handle"></span>
                                            </label>
                                            <a href="javascript:void(0)" class="editCatAjax editCat" data-attr="<?php echo $categorylist[$i]['category_id'];?>" >
                                            <i class="fa fa-pencil-square-o"></i> Edit
                                            </a>
                                            <!--<a href="#" data-toggle="modal" data-target="#cat-delete"><i class="fa fa-trash-o"></i> Delete</a>-->
                                            <a  href="javascript:void(0)" class="delCatAjax mr_2"  id="delCatAjax"  data-attr="<?php echo $categorylist[$i]['category_id'];?>"><i class="fa fa-trash-o"></i> Delete</a>
                                        </td>
                                    </tr>
                                 <?php }
								 } ?>
								...
								//	foreach($categorylist as $items){ ?>
									...
									<?php /*?><tr id="row_<?php echo $items['category_id'];?>" data-attr="<?php echo $items['category_id'];?>" class="cat_tr">
                                    	<td class="tdlink" href="<?php echo base_url().$this->user->root;?>/menu/dish/<?php echo $items['category_id'];?>" ><?php echo $items['category_name'];?></td>
                                        <td class="tdlink" href="<?php echo base_url().$this->user->root;?>/menu/dish/<?php echo $items['category_id'];?>" ><?php echo $items['subtitle'];?></td>
                                        <td>
                                        	<label class="switch">
                            ...
                            <!-- For Mobile View -->                            
                            <table class="table table-hover for-view-lower-481">
                                <tbody id="foo-mob">
                                
									<?php  
                                    if(count($categorylist)!=0){
                                        foreach($categorylist as $items){ ?>
                                        <tr id="row_<?php echo $items['category_id'];?>" data-attr="<?php echo $items['category_id'];?>" class="cat_tr_mob" >
                                        	<td class="for-handle"></td>
                                            <td>
                                                <!-- Name -->
                                                <div class="td-name">
                                                    <span class="td-title">Name</span>
                                                    <a href="<?php echo base_url().$this->user->root;?>/menu/dish/<?php echo $items['category_id'];?>">
                                                    <p style="margin-left:-7px;"><?php echo $items['category_name'];?></p>
                                                    </a>
                                                </div>
                                                <!-- End Name -->
                                                <!-- Sub Title -->
                                                ...
                                                <div class="td-action">
                                                    ...
                                                    <a href="javascript:void(0)" class="editCatAjax" data-attr="<?php echo $items['category_id'];?>" ><i class="fa fa-pencil-square-o"></i>Edit</a>
                                                    <!--<a href="#" data-toggle="modal" data-target="#cat-delete"><i class="fa fa-trash-o"></i>Delete</a>-->
