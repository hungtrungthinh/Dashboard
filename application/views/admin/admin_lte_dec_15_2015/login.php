...
//console.log(response);
	if(response.redirect_url){
		...
		$('#myform1')[0].reset();
		//alert('<?php //echo site_url(response.adminfolder+'/home')?>');
		
		window.location.href="<?php echo base_url() ;?>"+response.adminfolder+"/home";
		//window.location.href="<?php echo site_url(response.adminfolder+'/home')?>";
		//setTimeout(function(){
        ...
        <div class="form-box" id="login-box">
            ...
            <form id="myform1" action="<?php echo site_url('admin/login/authenticate_admin');?>" method="post">
                ...
                <div class="footer">                                                               
                 ...
                 <a href="javascript:void(0);" class="txt_link" id="change_link" ><span class="mr_2" data-toggle="modal" data-target="#myModal"  data-backdrop="static">Forgot Password</span></a>   <br />     
