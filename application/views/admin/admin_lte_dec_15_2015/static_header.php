...
<body class="skin-black">
		<header class="header">
            <a href="<?php echo base_url(); ?>admin" class="logo"  style=" padding-left:15px; padding-top:8px;">
                <!-- Add the class icon to your logo image or logo icon to add the margining -->
                <?php // if(isset($site_name)) {  echo $site_name; } else echo 'Logo OR Title';?>
                 <img src="<?php echo base_url().'assets/images/logo.png';?>"  alt="User Image" class=" " style="vertical-align:middle !important; width:100%" >
            </a>
